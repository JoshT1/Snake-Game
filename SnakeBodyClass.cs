...
class SnakeBodyClass : SpriteClass
{
    ...
    public void FollowPath(SpriteClass Ob, Texture2D turn, Texture2D stra)
    {
        ...
        if (this.IsCentered() && Ob.RotList[^2] != Ob.RotList[^1])
        {
        ...
        if(Ob.Texture == turn)
        {
            if (Ob.PathList[^1].X - this.PathList[^1].X == 2 && Ob.PathList[^1].Y == this.PathList[^1].Y)
            {
                this.Position = Ob.Position + new Vector2(-32, 0);
            }
            if (Ob.PathList[^1].X - this.PathList[^1].X == -2 && Ob.PathList[^1].Y == this.PathList[^1].Y)
            ...
            if (Ob.PathList[^1].Y - this.PathList[^1].Y == 2 && Ob.PathList[^1].X == this.PathList[^1].X)
            {
                this.Position = Ob.Position + new Vector2(0, -32);
            }
            if (Ob.PathList[^1].Y - this.PathList[^1].Y == -2 && Ob.PathList[^1].X == this.PathList[^1].X)
